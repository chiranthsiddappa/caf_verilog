...
project = 'CAF Verilog'
copyright = '2019, Chiranth Siddappa'
...
latex_documents = [
    (master_doc, 'CAFVerilog.tex', 'CAF Verilog Documentation',
...
man_pages = [
    (master_doc, 'cafverilog', 'CAF Verilog Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CAFVerilog', 'CAF Verilog Documentation',
     author, 'CAFVerilog', 'One line description of project.',
     'Miscellaneous'),
]
